                                ...
                                <table class="table table-striped" id="table1">
                                    <form action="" method="">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <?php foreach ($testimoni as $j) : ?>

                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td><?= $j['nama']; ?></td>
                                                    <td><img width="100px" class="img-thumbnail" src="<?= base_url() . "/assets/images/testimonial/" . $j['image']; ?>"></td>
                                                    <td><?= $j['email']; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url('Admin/' . $j['id'] . '/edit_testimoni') ?>"> <span class="btn btn-warning btn-s"><i class="bi bi-pencil-square"></i></span></a>
                                                        <form action="<?php echo base_url('Admin/' . $j['id'] . '/delete_testimoni') ?>" method="post" class="d-inline" onclick="return confirm('Apakah anda ingin menghapus data layanan ?');">
                                                            <? csrf_field(); ?>
