                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-1">
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="form-group mandatory ">
                                                    <div class="position-relative">
                                                        <label for="body" class="form-label">Jumlah Penduduk</label>
                                                        <div class="form-outline  mb-4">
                                                            <textarea class="form-control form-control-lg" id="jumlah_penduduk" name="jumlah_penduduk" rows="5"><?= $k['jumlah_penduduk']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group has-icon-left">
                                                <div class="form-group mandatory ">
                                                    <div class="position-relative">
                                                        <label for="body" class="form-label">Jumlah Laki-Laki</label>
                                                        <div class="form-outline  mb-4">
                                                            <textarea class="form-control form-control-lg" id="laki" name="laki" rows="5"><?= $k['laki']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-12 mb-1">
                                            <div class="form-group has-icon-left">
                                                <div class="form-group mandatory ">
                                                    <div class="position-relative">
                                                        <label for="body" class="form-label">Privasi Terjaga</label>
                                                        <div class="form-outline  mb-4">
                                                            <textarea class="form-control form-control-lg" id="keuntungan1" name="keuntungan1" rows="5"><?= $k['keuntungan1']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group has-icon-left">
                                                <div class="form-group mandatory ">
                                                    <div class="position-relative">
                                                        <label for="body" class="form-label">Pengajuan Layanan dengan Amana</label>
                                                        <div class="form-outline  mb-4">
                                                            <textarea class="form-control form-control-lg" id="keuntungan2" name="keuntungan2" rows="5"><?= $k['keuntungan2']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group has-icon-left">
                                                <div class="form-group mandatory ">
                                                    <div class="position-relative">
                                                        <label for="body" class="form-label">Ditanggapi secara cepat</label>
                                                        <div class="form-outline  mb-4">
                                                            <textarea class="form-control form-control-lg" id="keuntungan3" name="keuntungan3" rows="5"><?= $k['keuntungan3']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group has-icon-left">
                                                <div class="form-group mandatory ">
                                                    <div class="position-relative">
                                                        <label for="body" class="form-label">Jumlah Kartu Keluarga</label>
                                                        <div class="form-outline  mb-4">
                                                            <textarea class="form-control form-control-lg" id="jumlah_kk" name="jumlah_kk" rows="5"><?= $k['jumlah_kk']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group has-icon-left">
                                                <div class="form-group mandatory ">
                                                    <div class="position-relative">
                                                        <label for="body" class="form-label">Jumlah Prempuan</label>
                                                        <div class="form-outline  mb-4">
                                                            <textarea class="form-control form-control-lg" id="prempuan" name="prempuan" rows="5"><?= $k['prempuan']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
