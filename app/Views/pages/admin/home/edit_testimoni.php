        ...
        <div id="main">
            <div class="page-heading">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Edit Testimonial Home</h3>
                            <p class="text-subtitle text-muted">Silahkan edit testimonial user.</p>
                        </div>
                ...
                <?php foreach ($testimoni as $k) : ?>
                    <form method="post" action="<?php echo base_url('Admin/' . $k['id'] . '/update_testimoni') ?>" class="form-horizontal" role="form" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-1">
                                            <div class="form-group has-icon-left ">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control py-2" placeholder="Nama" id="nama" name="nama" value="<?= $k['nama']; ?>" />
                                                ...
                                                <div class="form-group mandatory ">
                                                    <div class="position-relative">
                                                        ...
                                                        <div class="form-outline  mb-4">
                                                            <textarea class="form-control form-control-lg" id="testimoni" name="testimoni" rows="5"><?= $k['testimoni']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-12 mb-1">
                                            <div class="form-group has-icon-left ">
                                                ...
                                                <div class="position-relative">
                                                    <input type="email" class="form-control py-2" placeholder="Email" id="email" name="email" value="<?= $k['email']; ?>" />
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-card-heading py-2"></i>
                                                    </div>
                                                    <div class="parsley-error filled" id="parsley-id-1" aria-hidden="false">
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="form-group ">
                                                    <div class="custom-file">
                                                        <div class="position-relative">
                                                            <label for="image" class="form-label custom-file-input"><img width="100px" class="img-thumbnail" src="<?= base_url() . "/assets/images/testimonial/" . $k['image']; ?>"></label>
