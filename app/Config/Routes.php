...
$routes->delete('/Admin/(:num)/delete_testimoni', 'Admin::delete_testimoni/$1');
...
$routes->post('/Admin/(:segment)/update_testimoni', 'Admin::update_testimoni/$1');
$routes->get('/Admin/(:segment)/edit_testimoni', 'Admin::edit_testimoni/$1');
